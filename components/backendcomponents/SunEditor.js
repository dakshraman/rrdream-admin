...
const SunEditorWrapper = forwardRef(({ value, onChange, error }, ref) => {
    ...
    return (_jsxs("div", { children: [_jsx(SunEditor, { ref: editorRef, height: "400px", setContents: value, onChange: (content) => {
                    onChange(content);
                }, setOptions: {
                    buttonList: [
                        ["undo", "redo"],
                    ...
                    defaultStyle: "font-size: 14px; line-height: 1.6; font-family: Arial, sans-serif;",
                } }), error && _jsx("span", { className: "error", style: { display: 'block', marginTop: '5px' }, children: error })] }));
});
