...
import { useGetStarlineRatesQuery, useUpdateStarlineRateMutation, } from "@/store/backendSlice/apiAPISlice";
const RATE_CONFIG = {
...
export default function StarlineGameRates() {
    ...
    const handleSubmit = async (e) => {
        ...
        setSubmitting(true);
        try {
            await Promise.all(rates.map((r) => updateStarlineRate({
                id: r.id,
    ...
    return (_jsxs(_Fragment, { children: [_jsx("style", { jsx: true, global: true, children: `
            ...
            ` }), _jsx("main", { style: { padding: "9px", minHeight: "100vh", overflow: "auto" }, children: _jsxs("div", { style: {
                        ...
                        padding: "24px 20px 28px",
                                ...
                                color: "#ef4444",
                                margin: "0 0 28px",
                            }, children: "Add Games Rate" }), isLoading ? (_jsx(SkeletonForm, {})) : (_jsxs("form", { onSubmit: handleSubmit, children: [_jsx("div", { className: "rates-grid", style: {
                                        display: "grid",
                                        ...
                                        return (_jsxs(Fragment, { children: [_jsx(FloatingInput, { label: cfg.col1, value: vals.base, onChange: (v) => handleChange(r.id, "base", v) }), _jsx(FloatingInput, { label: cfg.col2, value: vals.rate, onChange: (v) => handleChange(r.id, "rate", v) })] }, r.id));
                                    }) }), _jsx("button", { type: "submit", className: "submit-btn", disabled: submitting || isLoading, style: {
                                        marginTop: "28px",
                                        width: "100%",
                                        padding: "14px",
                                        background: "#ef4444",
...
function FloatingInput({ label, value, onChange }) {
    ...
    return (_jsxs("div", { style: { position: "relative" }, children: [_jsx("label", { style: {
                    ...
                    whiteSpace: "nowrap",
                }, children: label }), _jsx("input", { className: "rate-input", type: "number", value: value, onChange: (e) => onChange(e.target.value), onFocus: () => setFocused(true), onBlur: () => setFocused(false), style: {
                    width: "100%",
