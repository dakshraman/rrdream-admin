...
import { useGetUsersQuery, useDeductFundsMutation, } from "@/store/backendSlice/apiAPISlice";
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const msg = (response === null || response === void 0 ? void 0 : response.message) ||
                `${formatCurrency(parsedAmount)} deducted from ${(selectedUser === null || selectedUser === void 0 ? void 0 : selectedUser.name) || "user"} successfully!`;
            toast.success(msg);
            setLastSuccess({
