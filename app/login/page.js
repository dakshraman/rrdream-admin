    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            if (payload === null || payload === void 0 ? void 0 : payload.token) {
                ...
                toast.error((payload === null || payload === void 0 ? void 0 : payload.message) || "Invalid credentials", { duration: 1500 });
            }
        }
        catch (error) {
            console.error("Login error:", error);
            toast.error(((_a = error === null || error === void 0 ? void 0 : error.data) === null || _a === void 0 ? void 0 : _a.message) || "Something went wrong. Please try again.", { duration: 1500 });
        }
        finally {
            setLoading(false);
        }
    };
    return (_jsxs(_Fragment, { children: [_jsx("div", { className: "login-wrapper", children: _jsx("div", { className: "form-wrap", children: _jsx("div", { className: "login-form", "data-tab": "login-form", children: _jsxs("form", { className: "model-body", onSubmit: handleLogin, children: [_jsx("div", { className: "logo", children: _jsx("img", { src: "/admin-assets/img/logo.png", alt: "Logo", style: { width: "123px" } }) }), _jsxs("div", { className: "form", children: [_jsxs("div", { className: "form-group", children: [_jsx("label", { htmlFor: "txtusername", children: "User Name*" }), _jsx("input", { type: "text", id: "txtusername", className: "form-control", placeholder: "Enter user name", value: username, onChange: (e) => setusername(e.target.value) })] }), _jsxs("div", { className: "form-group", children: [_jsx("label", { htmlFor: "txtpassword", children: "Password*" }), _jsxs("div", { className: "password-wrap", children: [_jsx("input", { type: showPassword ? "text" : "password", id: "txtpassword", className: "form-control login-password", placeholder: "Enter Password", value: password, onChange: (e) => setpassword(e.target.value) }), _jsx("span", { onClick: () => setShowPassword(!showPassword), style: {
                                                                position: "absolute",
                                                                right: "10px",
                                                                top: "50%",
                                                        ...
                                                        <g fill="none" stroke="#666" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5">
                                                            ...
                                                            } })] })] }), _jsx("button", { type: "submit", className: "form-group btn w-100", disabled: isLoading || loading, children: isLoading || loading ? "Signing in..." : "Sign in" })] })] }) }) }) }), loading && _jsx(Pageloading, {})] }));
}
