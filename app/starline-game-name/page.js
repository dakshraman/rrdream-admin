...
import { useGetStarlineGamesQuery, useAddStarlineGameMutation, useUpdateStarlineGameMutation, useToggleStarlineGameMutation, } from "@/store/backendSlice/apiAPISlice";
// ─────────────────────────────────────────────────────────────────────────────
...
function ScrollColumn({ items, selectedIndex, onSelect, width = 56 }) {
    ...
    return (_jsxs("div", { style: {
            ...
            flexDirection: "column", alignItems: "center",
                    ...
                    pointerEvents: "none", zIndex: 3,
                } }), _jsx("style", { children: `.scroll-hide::-webkit-scrollbar{display:none}` })] }));
}
...
function GameModal({ open, onClose, editData }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (isEdit) {
                const res = await updateStarlineGame(Object.assign({ id: editData.id }, form)).unwrap();
    ...
    return (_jsx("div", { style: {
            ...
            }, onClick: (e) => e.stopPropagation(), children: [_jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "22px" }, children: [_jsx("h2", { style: { margin: 0, fontSize: "16px", fontWeight: 700, color: "#1f2937" }, children: isEdit ? "Edit Game" : "Add Game" }), _jsx("button", { onClick: onClose, disabled: isSaving, style: { background: "transparent", border: "none", fontSize: "26px", cursor: "pointer", color: "#6b7280", lineHeight: 1 }, children: "\u00D7" })] }), _jsxs("form", { onSubmit: handleSubmit, children: [_jsxs("div", { style: { marginBottom: "16px" }, children: [_jsx("label", { style: { display: "block", marginBottom: "6px", fontSize: "13px", fontWeight: 600, color: "#374151" }, children: "Game Name" }), _jsx("input", { name: "name", value: form.name, onChange: handleChange, placeholder: "e.g. Morning Game", style: { width: "100%", padding: "9px 12px", border: "1px solid #d1d5db", borderRadius: "8px", fontSize: "13px", outline: "none", boxSizing: "border-box", color: "#1f2937" }, autoComplete: "off" })] }), _jsxs("div", { style: { marginBottom: "16px" }, children: [_jsx("label", { style: { display: "block", marginBottom: "6px", fontSize: "13px", fontWeight: 600, color: "#374151" }, children: "Game Name (Hindi)" }), _jsx("input", { name: "name_hindi", value: form.name_hindi, onChange: handleChange, placeholder: "e.g. \u0938\u0941\u092C\u0939 \u0915\u093E \u0916\u0947\u0932", style: { width: "100%", padding: "9px 12px", border: "1px solid #d1d5db", borderRadius: "8px", fontSize: "13px", outline: "none", boxSizing: "border-box", color: "#1f2937" }, autoComplete: "off" })] }), _jsxs("div", { style: { marginBottom: "16px" }, children: [_jsx("label", { style: { display: "block", marginBottom: "6px", fontSize: "13px", fontWeight: 600, color: "#374151" }, children: "Time" }), _jsx(TimePicker, { value: form.time, onChange: (val) => setForm((p) => (Object.assign(Object.assign({}, p), { time: val }))), placeholder: "Select time" }), form.time && (_jsxs("p", { style: { margin: "5px 0 0", fontSize: "11px", color: "#9ca3af" }, children: ["Sends to API: ", _jsx("strong", { style: { color: "#374151" }, children: form.time })] }))] }), _jsxs("div", { style: { display: "flex", gap: "10px", justifyContent: "flex-end", marginTop: "24px" }, children: [_jsx("button", { type: "button", onClick: onClose, disabled: isSaving, style: { padding: "9px 16px", background: "#f3f4f6", color: "#374151", border: "1px solid #e5e7eb", borderRadius: "8px", cursor: "pointer", fontSize: "13px", fontWeight: 500 }, children: "Cancel" }), _jsx("button", { type: "submit", disabled: isSaving, style: { padding: "9px 20px", background: "#7c3aed", color: "#fff", border: "none", borderRadius: "8px", fontSize: "13px", fontWeight: 600, cursor: isSaving ? "not-allowed" : "pointer", opacity: isSaving ? 0.7 : 1 }, children: isSaving ? "Saving..." : isEdit ? "Update Game" : "Add Game" })] })] })] }) }));
}
// ─── Main Page ─────────────────────────────────────────────────────────────────
export default function StarlineGameName() {
    ...
    const columns = [
        ...
        {
            name: _jsx("span", { className: "col-header", style: { fontSize: "12px" }, children: "Game Name (Hindi)" }),
            selector: (row) => row.name_hindi || "",
            sortable: true,
            cell: (row) => _jsx("span", { style: { fontSize: "13px" }, children: row.name_hindi || "—" }),
        },
        {
            name: _jsx("span", { className: "col-header", children: "Time" }),
            selector: (row) => row.time || "",
            sortable: true,
            width: "110px",
            cell: (row) => (_jsx("span", { style: { fontFamily: "monospace", fontSize: "13px", color: "#374151" }, children: row.time || "—" })),
        },
        {
