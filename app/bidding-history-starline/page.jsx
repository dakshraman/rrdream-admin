...
export default function BiddingHistoryStarline() {
    ...
    const hasActiveFilters = filters.game_name || filters.game_type || filters.search || filters.date !== today;
        ...
        return (
            <main style={{ padding: "20px" }}>
                <div style={{
                    ...
                    <h3 style={{ marginBottom: "10px" }}>Error loading starline bidding history</h3>
                ...
                <DataTable
                    title={
                        <div style={{
                            ...
                            <span style={{ fontSize: "18px", fontWeight: "600" }}>Starline Bidding History</span>
                            {totalRows > 0 && (
                                <span style={{
                                    fontSize: "12px",
                                    color: "#6b7280",
                    ...
                    noDataComponent={
                        <div style={{
                            ...
                            <p style={{ fontSize: "16px", marginBottom: "5px" }}>No starline bidding history found</p>
